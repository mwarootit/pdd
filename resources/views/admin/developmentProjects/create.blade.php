        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.developmentProject.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.development-projects.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('starting_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="starting_date" id="starting_date" value="{{ old('starting_date') }}">
