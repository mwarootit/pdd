        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.listOfMinistryProject.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.list-of-ministry-projects.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('name_of_the_project') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_of_the_project" id="name_of_the_project" value="{{ old('name_of_the_project', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('date_of_implementation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_of_implementation" id="date_of_implementation" value="{{ old('date_of_implementation') }}">
                        ...
                        <div class="form-group {{ $errors->has('location_village') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="location_village" id="location_village" value="{{ old('location_village', '') }}">
